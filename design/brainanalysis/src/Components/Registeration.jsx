                    ...
                    <div>
                        ...
                        <form action="" method="post">
                            <label htmlFor="email" className="flex flex-col pt-6 text-lg opacity-80">Full Name:
                                <input className="px-2 py-1 border bg-stone-50 border-stone-800 rounded-lg  mt-2 placeholder:text-stone-500 placeholder:font-light placeholder:text-sm" type="text" placeholder="Full Name" id="email" name="email" />
                            </label>
                            <label htmlFor="email" className="flex flex-col pt-6 text-lg opacity-80">Email:
                                <input className="px-2 py-1 border bg-stone-50 border-stone-800 rounded-lg  mt-2 placeholder:text-stone-500 placeholder:font-light placeholder:text-sm" type="text" placeholder="example@gmail.com" id="email" name="email" />
                            </label>
